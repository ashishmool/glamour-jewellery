...
<table width="600" style="font-family: Arial, Helvetica, sans-serif; font-size: 0.875rem; color: rgb(51, 51, 51);">
    ...
    <tr>
        <td style="padding: 32px 48px 0 48px;">
            <div style="float: left; margin-left: 16px;">
                <p style="color:rgb(189, 9, 18); font-size: 16px; font-weight: 600; margin-bottom: 8px; margin-top: 8px;">Glamour Jewellery</p>
                <p style="color:rgb(66, 93, 184); font-size: 14px; font-weight: 600; margin-top: 8px;">www.glamourjewellery-nepal.com.np</p>
            </div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="padding: 1rem 48px 1.5rem 48px">For additional help or information, email us at <a href="#" style="color: rgb(26, 115, 232)">glamourjewellerynp@gmail.com</a> </td>
    </tr>
    <tr>
        <td style="background-color: rgb(66 93 184); padding: 1rem 0;">
            <table style="font-size: 0.75rem; color: rgb(255,255,255); width: 100%; text-align: center">
                ...
                <tr>
                    <td>Glamour Jewellery System</td>
                </tr>
            </table>
        </td>
    </tr>
